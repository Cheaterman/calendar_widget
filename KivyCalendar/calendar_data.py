...
class TimeEncoding:
    ...
    def __enter__(self):
        self.oldlocale = _locale.getlocale(_locale.LC_TIME) # noqa
        _locale.setlocale(_locale.LC_TIME, self.locale) # noqa

    def __exit__(self, *args):
        _locale.setlocale(_locale.LC_TIME, self.oldlocale) # noqa
